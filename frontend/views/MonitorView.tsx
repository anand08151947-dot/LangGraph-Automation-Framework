...
import { getRunConfig, getStm, getLtm } from '../services/api.runs';
...
const MonitorView: React.FC = () => {
  ...
  const displayLogs = [...(selectedRun?.logs || []), ...liveLog];
            ...
            <>
              ...
              {activeTab === 'logs' && (
                <div className="space-y-4">
                  ...
                  <div className="bg-slate-900 rounded-xl p-6 font-mono text-sm h-72 overflow-y-auto space-y-2">
