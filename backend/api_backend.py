...
cp .env.example .env
# Edit .env and fill in your LLM API keys / LM Studio URL
...
- **MCP Servers**: {len(config_json.get("mcp_servers", []))}
...
## Deployment
This is a standalone Python script. Deploy it anywhere Python runs:
- Local machine, Docker container, AWS Lambda, Cloud Run, VM, etc.
